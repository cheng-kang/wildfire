...
!> **重要消息：**如果你正打算或已经在你的网站加入 `wildfire`，请使用带有版本号 `0.3.7` 的 CDN 链接来加载脚本，比如：`https://unpkg.com/wildfire@0.3.7/dist/wildfire.auto.js`。我们正在准备一个大的更新，你的配合将能帮助我们让这个过渡变得更平滑。我们在之后会发布更多关于此事的消息。万分感谢！
...
<img src="_static/images/alipay.jpg" width="160">
<img src="_static/images/wechat.jpg" width="160">
