(() => {
  ...
  function startWildfire () {
    ...
    loadCSS(`https://unpkg.com/@chengkang/wildfire/dist/${databaseProvider}/static/wildfire.css`)
    let jsList = []
    ...
    jsList.push(`https://unpkg.com/@chengkang/wildfire/dist/${databaseProvider}/wildfire.min.js`)
